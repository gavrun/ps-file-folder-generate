...
$rootPath = Join-Path (Get-Location) 'root50'  # Root path of the SMB share

# Configurable parameters
$totalSizeGB = 0.01    # Total size of the share (1 GB)
$fileSizeMB = 1      # Each file size (in MB)
$folderCount = 4       # Number of first-level folders
